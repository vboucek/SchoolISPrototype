...
export class SemesterService {
  ...
  public async findAll() {
    ...
    return semesters.map((semester, ind, arr) => plainToClass(SemesterDto, { ...semester }, { excludeExtraneousValues: true }));
  }
  ...
  public async findOne(id: number) {
    ...
    return plainToClass(SemesterDto, { ...semester }, { excludeExtraneousValues: true });
  }
