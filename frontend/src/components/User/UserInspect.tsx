...
export const UserInspect = () => {
    ...
    const canEdit = loggedInUser.roles.includes(UserRole.admin) || loggedInUser.id == user.id;
        ...
        <div className="text-black laptop:mt-20 laptop:mx-20 phone:mt-0 phone:mx-2">
            ...
            <div className="flex">
                ...
                <div className="flex flex-col px-3 w-2/6 border-l-2 border-gray-700 justify-between">
                    {canEdit &&
                        <Link to={`/user/${user.id}/edit`} className="text-black m-2" >
                            <button className="w-full bg-gray-400">Edit profile</button>
                        </Link>
                    }
                    {canDelete &&
                        <Link to={`/user/${user.id}/delete`} className="text-black m-2" >
                            <button className="w-full bg-red-400">Delete profile</button>
                        </Link>
                    }
                    <div className="flex flex-col">
