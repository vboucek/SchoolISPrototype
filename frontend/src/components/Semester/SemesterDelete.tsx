...
export const SemesterDelete = () => {
  ...
  return (
    <div className="text-black phone:mt-0 laptop:mt-20 phone:mx-2 laptop:mx-20">
      <h1 className="font-bold laptop:text-6xl phone:text-3xl">Do you really want to delete this semester?</h1>
      <div className="flex flex-row gap-5">
        <div className="flex flex-row mt-5 w-32">
          <button onClick={() => handleDeleteSemester} className="bg-gray-400 w-full border-black">Yes</button>
        </div>
        <div className="flex flex-row mt-5 w-32">
